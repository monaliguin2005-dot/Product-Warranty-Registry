...
export const CONTRACT_ADDRESS =
  "CAEZSYKBZZ4Y7UPGYAFNANYZGNR3ILVCHEETIZEJQDFTBCDA2XUZJUKZ";
 ...
 * Calls: register_warranty(product_id: String, owner: String, expiry_date: String)
 */
export async function registerWarranty(
  ...
  return callContract(
    "register_warranty",
    [toScValString(productId), toScValString(owner), toScValString(expiryDate)],
    caller,
    true
  );
}
...
/**
 * Get warranty details (read-only).
 * Calls: get_warranty(product_id: String) -> (String, String)
 * Returns: [owner, expiry_date] or null
 */
